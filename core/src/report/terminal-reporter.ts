...
export class TerminalReporter {
  public static generate(report: AeoReportResult): string {
    ...
    lines.push(`\x1b[1m  AEO & SEO Linter Report — Unified SEO, GEO & AEO Audit Suite\x1b[0m`);
    lines.push(`  Target URL: \x1b[4m${report.url}\x1b[0m`);
    ...
    for (const cat of Object.values(report.categories)) {
      ...
      for (const ref of cat.auditRefs) {
        ...
        const icon = isPass ? '\x1b[32m✔\x1b[0m' : '\x1b[31m✖\x1b[0m';
